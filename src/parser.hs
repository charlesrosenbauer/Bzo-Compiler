...
happyThen :: () => BzoToken a -> (a -> BzoToken b) -> BzoToken b
happyThen = ((>>=))
happyReturn :: () => a -> BzoToken a
happyReturn = (return)
happyThen1 m k tks = ((>>=)) m (\a -> k a tks)
happyReturn1 :: () => a -> b -> BzoToken a
happyReturn1 = \a tks -> (return) a
happyError' :: () => [(BzoToken)] -> BzoToken a
happyError' = parseBzoError

bzoParser tks = happySomeParser where
