...
addDef (DefinitionTable defs ids top) def =
  ...
  in (DefinitionTable defs' ids' (top+1))
...
queryDef (DefinitionTable defs ids top) defid = M.lookup defid defs
...
queryIds (DefinitionTable defs ids top) defid =
...
queryIdFile dtab@(DefinitionTable defs ids top) defid fileid =
